          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-8">
            <section>
              ...
              <div className="text-slate-300 space-y-4">
                <p>
                  By accessing or using Use AI Writer (&quot;the Service&quot;), you agree to be bound by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, do not use the Service.
                </p>
                <p>
                  These Terms constitute a legally binding agreement between you and Use AI Writer. By using our Service, you acknowledge that you have read, understood, and agree to be bound by these Terms.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-slate-300 space-y-4">
                <p>
                  Use AI Writer provides AI-powered writing assistance, including:
                </p>
            ...
            <section>
              ...
              <div className="text-slate-300 space-y-4">
                ...
                <p>
                  <strong className="text-white">Service Content:</strong> All software, designs, logos, and other materials provided through the Service are owned by Use AI Writer and protected by intellectual property laws.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-slate-300">
                <p>
                  You agree to indemnify, defend, and hold harmless Use AI Writer and its affiliates from any claims, damages, losses, or expenses (including legal fees) arising from:
                </p>
