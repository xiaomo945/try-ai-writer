        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-display font-extrabold text-slate-900">
              Try <span className="text-emerald-600">AI</span> Writer
            </span>
          </Link>
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/login"
              className="rounded-2xl border border-slate-300 hover:border-emerald-400 px-5 py-2 text-sm font-medium text-slate-700 hover:text-emerald-700 transition-all"
            >
              Sign In
            </Link>
          </div>
