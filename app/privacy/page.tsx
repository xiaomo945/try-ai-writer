      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="glass-card p-8 md:p-12">
          ...
          <div className="prose prose-invert prose-slate max-w-none space-y-8">
            <section>
              ...
              <div className="text-slate-300 space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li><strong className="text-white">Usage Data:</strong> Content you generate, preferences, and interaction patterns with our service</li>
                  <li><strong className="text-white">Communication Data:</strong> Messages and correspondence you send to us</li>
                  <li><strong className="text-white">Payment Information:</strong> Processed securely through our payment provider (Creem)</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-display font-bold text-white mb-4">3. Data Protection</h2>
              <div className="text-slate-300 space-y-4">
                <p>
                ...
                <p className="mt-4">
                  <strong className="text-white">Important:</strong> Your content and brand voice data are never used to train AI models shared with other users. Each user&apos;s data is isolated and protected.
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-display font-bold text-white mb-4">4. Cookie Policy</h2>
              <div className="text-slate-300 space-y-4">
                <p>
            ...
            <section>
              ...
              <div className="text-slate-300 space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li><strong className="text-white">Payment Processing:</strong> Creem (payments are processed securely)</li>
                  <li><strong className="text-white">Authentication:</strong> Google OAuth (you authenticate with Google)</li>
                  <li><strong className="text-white">Analytics:</strong> Vercel Analytics (usage statistics)</li>
                  <li><strong className="text-white">AI Services:</strong> Claude API and DeepSeek API (for content generation)</li>
                </ul>
              </div>
            </section>
